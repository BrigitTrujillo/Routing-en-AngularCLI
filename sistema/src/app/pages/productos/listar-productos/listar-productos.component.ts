        ...
        content: [
          {
            table: {
              ...
              body: [
                [{ text: 'Nombre', bold: true }, { text: 'Categoria', bold: true }, { text: 'Ubicacion', bold: true }, { text: 'Precio', bold: true }, { text: 'Imagen', bold: true }],
                ...
                [this.listProductos[3].producto, this.listProductos[3].categoria, this.listProductos[3].ubicacion, this.listProductos[3].precio]
              ]
